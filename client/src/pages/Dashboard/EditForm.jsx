  ...
  return (
    <>
      ...
      <form className="update-form-container" onSubmit={handleFormSubmit}>
        <Form.Group>
          <label htmlhtmlFor="name-input" className="input-label">
            Update your name:
          </label>
          <input
            id="name-input"
        ...
        <Form.Group>
          <label htmlhtmlFor="username-input" className="input-label">
        ...
        <Form.Group>
          <label htmlhtmlFor="genre-input" className="input-label">
        ...
        <Form.Group>
          <label htmlhtmlFor="bio-input" className="input-label">
            Update your bio:
          </label>
          <input
            id="bio-input"
